...
<head>
  ...
  <title>Noticia | Perspectivas</title>
...
<body>
  ...
  <header class="site-header">
    <div class="container header-inner">
      <div class="brand">
          ...
          <div>
            <h1 class="site-title">Perspectivas</h1>
          </div>
        </a>
      </div>
    </div>
    <nav class="main-nav">
      ...
      <!-- <a href="#">Programa</a> (Lo añadiremos en el futuro) -->
    </nav>
  ...
  <main class="container">
    <!-- Este es el contenedor que el script va a rellenar. No necesita nada más. -->
    <article id="contenido-noticia" class="full-article">
      <p style="text-align: center; padding: 40px;">Cargando noticia...</p>
    </article>
  </main>
